...
export function ComposerControls({ autoSpeak, busy, busyAction, canSteer, canSubmit, compactModelPill = false, conversation, disabled, formatControls = null, hasComposerPayload, state, voiceStatus, onDictate, onSteer, onToggleAutoSpeak }) {
    const { t } = useI18n();
    const c = t.composer;
